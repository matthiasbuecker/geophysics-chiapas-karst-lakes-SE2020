...
xoffset = 57.5*0;         % x offset relative to longer TDIP profile MET19-3

% Read mesh
[elemx,elemz] = vtk2patch('../03_inverted/MET19-3b/velocity.vtk');
% Read velocity model
vel = dlmread('../03_inverted/MET19-3b/velocity.vector');
% Read coverage
cov = dlmread('../03_inverted/MET19-3b/velocity-scov.vector');
% Geophone positions
geop = 2.5:5:120;
...
h = gca;
h.XAxis.MinorTickValues=0:2:200;
