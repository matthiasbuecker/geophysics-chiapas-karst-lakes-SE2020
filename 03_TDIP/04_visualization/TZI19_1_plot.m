...
zoffset = 12.4;             % Depth offset (with respect to water surface)
                            % Referred to depth of TEM TZI44
xoffset = 169;              % X offset relative to longer SBP profile 8m)
...
% Set size of axes
axes('units','centimeters','Position',[1 0.6 12 4],'Box','on');
...
set(gca,'FontSize',fs)
axis ij
axis([xoffset max(elec(:,2))+xoffset 0 80]) % axis tight
